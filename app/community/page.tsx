...
export default async function CommunityOverview() {
  const data = await client.fetch(`*[_type == "community"][0]`);

  return (
    <div className="container pt-4 pb-5">
      <h1 className="fw-bold text-success mb-4">Community Partnership</h1>

      {/* Centered Carousel */}
      <div className="row justify-content-center">
        <div className="col-md-3 mb-4 d-flex justify-content-center">
          <Carousel
            images={data.communityOverviewImages}
            id="communityOverviewCarousel"
          />
        </div>
      </div>
