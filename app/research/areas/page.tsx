...
export default async function ResearchAreas() {
  ...
  return (
    <div className="container pt-4 pb-5">
      <h1 className="fw-bold text-success mb-4">Research Areas</h1>

      {/* Centered Carousel */}
      <div className="row justify-content-center">
        <div className="col-md-3 mb-4 d-flex justify-content-center">
          <Carousel images={data.areasImages} id="researchAreasCarousel" />
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-12">
          <PortableText value={data.areas} components={components} />
        </div>
      </div>
    </div>
  );
